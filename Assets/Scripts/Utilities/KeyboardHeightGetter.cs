...
{
    public static class KeyboardHeightGetter
    {
        public static int GetRelativeKeyboardHeight(RectTransform canvasRectTransform, bool includeInput)
        {
            int keyboardHeight = GetKeyboardHeight(includeInput);
            float screenToRectRatio = Screen.height / canvasRectTransform.rect.height;
